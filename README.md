...
<body>
    ...
    <div style="white-space: nowrap; overflow-x: auto; padding: 1rem;">
        <div style="display: inline-block; margin-right: 10px;" onclick="openModal(this)">
            <img src="C:\Users\acer\Interactive\Interactiveimage\galleryapp\static\st 2.jpg" style="height: 200px;">
        </div>
        <div style="display: inline-block; margin-right: 10px;" onclick="openModal(this)">
            <img src="C:\Users\acer\Interactive\Interactiveimage\galleryapp\static\st3.jpg" style="height: 200px;">
        </div>
        <div style="display: inline-block; margin-right: 10px;" onclick="openModal(this)">
            <img src="C:\Users\acer\Interactive\Interactiveimage\galleryapp\static\st4.jpg" style="height: 200px;">
        </div>
        <div style="display: inline-block;" onclick="openModal(this)">
            <img src="C:\Users\acer\Interactive\Interactiveimage\galleryapp\static\stranger 1.jpg" style="height: 200px;">
        </div>
    </div>
